...
export default function RestablecerContrasenaCandidatoPage() {
    ...
    const onSubmit = async (data: FormValues) => {
        try {
            ...
            if (res.data.ok) {
                ...
                router.push("/login"); // 👈 candidatos vuelven a /login
            } else {
                    ...
                    <Card className="overflow-hidden p-0">
                        <CardContent className="grid p-0 md:grid-cols-2">
                            <div className="p-6 md:p-8">
                                ...
                                <p className="mb-6 text-sm text-muted-foreground text-center md:text-left">
                            ...
                            <div className="bg-muted relative hidden md:block">
                                <Image
                                    src="/portada5.jpg"
                                    alt="Portada Restablecer Contraseña"
                                    width={100}
                                    height={100}
                                    quality={100}
                                    priority={true}
